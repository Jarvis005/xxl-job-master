 ...
 */
@JobHandler(value = "resetNumOfFiveMinJobHandler")
@Component
public class ResetNumOfFiveMinJobHandler extends IJobHandler {
    @Autowired
    ...
    public ReturnT<String> execute(String param) throws Exception {
        ...
        KlbDeviceStatusPo po = new KlbDeviceStatusPo(
                null, startTime, endTime, EventTypeEnum.THIRTEEN_OO.getCode(), EventTypeEnum.THIRTEEN_OO.getMsg(),
                resetNum+"", endTime);
