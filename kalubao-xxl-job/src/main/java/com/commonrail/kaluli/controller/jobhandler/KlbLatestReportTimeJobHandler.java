 ...
 */
@JobHandler(value = "klbLatestReportTimeJobHandler")
@Component
public class KlbLatestReportTimeJobHandler extends IJobHandler {
    @Autowired
    ...
    public ReturnT<String> execute(String param) throws Exception {
        ...
        List<KlbTimePo> pos = otherService.getKlbLatestReportTimeList();
        for(KlbTimePo klbTimePo : pos) {
            ...
            KlbDeviceStatusPo po = new KlbDeviceStatusPo(
                    deviceId, null, null, EventTypeEnum.TWO_OO.getCode(), EventTypeEnum.TWO_OO.getMsg(),
